...
function drawSplitLogo(address: string) {
return `
    <svg class="h-72 w-72" fill="${getHslColor(address, 0)}" viewBox="0 0 1024 1024" stroke="none"  xmlns="http://www.w3.org/2000/svg">
